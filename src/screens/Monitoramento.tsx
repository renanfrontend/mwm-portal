        ...
        <div className="level is-mobile">
          <div className="level-left">
            <div className="buttons">
              ...
              <span className="title is-4 mb-0" style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }}>Monitoramento</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="screen-content p-5" style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', overflowY: 'auto' }}>
        <div className="has-text-centered">
          ...
          <p className="subtitle is-6 has-text-grey-light">
            Estamos preparando novidades para o módulo de monitoramento.
          </p>
        </div>
      </div>
