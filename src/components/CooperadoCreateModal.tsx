      ...
      <div className="modal-card" style={{ maxWidth: '800px', width: '100%' }}>
        ...
        <section className="modal-card-body">
          <div className="columns is-multiline">
            ...
            <div className="column is-half"><div className="field"><label className="label is-small">Transportadora</label><div className="control"><div className="select is-fullwidth"><select value={transportadora} onChange={e => setTransportadora(e.target.value)}><option value="">Selecione</option><option value="Primato">Primato</option><option value="Agrocampo">Agrocampo</option><option value="MWM">MWM</option><option value="Tupy">Tupy</option></select></div></div></div></div>
            <div className="column is-half"><div className="field"><label className="label is-small">Tipo de veículo</label><div className="control"><div className="select is-fullwidth"><select value={tipoVeiculo} onChange={e => setTipoVeiculo(e.target.value)}><option value="">Selecione</option><option value="Caminhão de dejetos">Caminhão de dejetos</option><option value="Caminhão de ração">Caminhão de ração</option><option value="Empilhadeira">Empilhadeira</option></select></div></div></div></div>
            <div className="column is-half"><div className="field"><label className="label is-small">Motorista</label><div className="control"><input className="input" type="text" value={motorista} onChange={e => setMotorista(e.target.value)} /></div></div></div>
            ...
            <div className="column is-half"><div className="field"><label className="label is-small">Placa</label><div className="control"><input className="input" type="text" value={placa} onChange={e => setPlaca(e.target.value)} /></div></div></div>
            <div className="column is-half"><div className="field"><label className="label is-small">Certificado</label><div className="control"><div className="select is-fullwidth"><select value={certificado} onChange={e => setCertificado(e.target.value)}><option value="">Selecione</option><option value="Ativo">Ativo</option><option value="Inativo">Inativo</option></select></div></div></div></div>
            <div className="column is-half"><div className="field"><label className="label is-small">Doam dejetos</label><div className="control"><div className="select is-fullwidth"><select value={doamDejetos} onChange={e => setDoamDejetos(e.target.value)}><option value="">Selecione</option><option value="Sim">Sim</option><option value="Não">Não</option></select></div></div></div></div>
            <div className="column is-half"><div className="field"><label className="label is-small">Fase do dejetos</label><div className="control"><div className="select is-fullwidth"><select value={fase} onChange={e => setFase(e.target.value)}><option value="">Selecione</option><option value="Term. Frimesa">Term. Frimesa</option><option value="GRSC">GRSC</option><option value="Crechário">Crechário</option><option value="UPD">UPD</option></select></div></div></div></div>
            ...
            <div className="column is-half"><div className="field"><label className="label is-small">Técnico</label><div className="control"><input className="input" type="text" value={tecnico} onChange={e => setTecnico(e.target.value)} /></div></div></div>
            <div className="column is-half"><div className="field"><label className="label is-small">Telefone</label><div className="control"><input className="input" type="text" value={telefone} onChange={e => setTelefone(e.target.value)} /></div></div></div>
            ...
            <div className="column is-full"><label className="label is-small">Localização</label><a href={`https://www.google.com/maps/search/?api=1&query=${latitude},${longitude}`} target="_blank" rel="noopener noreferrer" className="button is-small is-link is-light"><span className="icon"><MdMap /></span><span>Ver mapa</span></a></div>
          </div>
        </section>
