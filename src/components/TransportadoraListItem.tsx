...
export const TransportadoraListItem: React.FC<Props> = ({ 
  ...
  // CORREÇÃO AQUI:
  // 1. Removemos 'numero' e 'bairro' que não existem na interface.
  // 2. Trocamos 'estado' por 'uf' que é o nome correto na interface.
  // 3. Usamos uma lógica condicional para exibir o endereço se ele existir.
