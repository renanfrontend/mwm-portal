...
import { entregaInsumoService } from '../../../services/activities/entrega-insumo';
...
export const EntregaInsumoForm: React.FC<Props> = ({
  ...
  useEffect(() => {
    if (open) {
      entregaInsumoService.getTransportadoras()
